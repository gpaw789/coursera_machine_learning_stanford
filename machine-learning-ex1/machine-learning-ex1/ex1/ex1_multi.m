...
%               to predict the price of a 1650 sq-ft, 3 br houses.
%
...
%need to normalise the new input value, because the theta is based off normalised X
%otherwise you get freakishly big values
kk = (1650-mu(1))/sigma(1);
yy = (3-mu(2))/sigma(2);
price = theta(1,1) + theta(2,1)*kk + theta(3,1)*yy; % You should change this
